          ...
          <div class="grid gap-x-6 gap-y-4 sm:grid-cols-2">
            ...
            >
              ...
              <UInputMenu
                ...
                :autocapitalize="input.normalization?.case === 'uppercase' ? 'characters' : undefined"
                :autocorrect="input.normalization ? 'off' : undefined"
                :spellcheck="input.normalization ? false : undefined"
                autocomplete="off"
                class="w-full"
                @update:model-value="(value) => emit('update', input, value)"
              />
